    ...
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        assetConversion: {
            ...
            addLiquidity: AugmentedSubmittable<(asset1: PalletAssetConversionNativeOrAssetId | {
                ...
                Asset: any;
            } | string | Uint8Array, asset2: PalletAssetConversionNativeOrAssetId | {
                Native: any;
            } | {
                Asset: any;
             ...
             **/
            createPool: AugmentedSubmittable<(asset1: PalletAssetConversionNativeOrAssetId | {
                Native: any;
            } | {
                Asset: any;
            } | string | Uint8Array, asset2: PalletAssetConversionNativeOrAssetId | {
                ...
                Asset: any;
            } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletAssetConversionNativeOrAssetId, PalletAssetConversionNativeOrAssetId]>;
            /**
             ...
             **/
            swapExactTokensForTokens: AugmentedSubmittable<(path: Vec<PalletAssetConversionNativeOrAssetId> | (PalletAssetConversionNativeOrAssetId | {
                Native: any;
            } | {
                Asset: any;
            } | string | Uint8Array)[], amountIn: u128 | AnyNumber | Uint8Array, amountOutMin: u128 | AnyNumber | Uint8Array, sendTo: AccountId32 | string | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<PalletAssetConversionNativeOrAssetId>, u128, u128, AccountId32, bool]>;
            /**
             * See [`Pallet::swap_tokens_for_exact_tokens`].
             **/
            swapTokensForExactTokens: AugmentedSubmittable<(path: Vec<PalletAssetConversionNativeOrAssetId> | (PalletAssetConversionNativeOrAssetId | {
                Native: any;
            } | {
                Asset: any;
            } | string | Uint8Array)[], amountOut: u128 | AnyNumber | Uint8Array, amountInMax: u128 | AnyNumber | Uint8Array, sendTo: AccountId32 | string | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [Vec<PalletAssetConversionNativeOrAssetId>, u128, u128, AccountId32, bool]>;
            /**
             * Generic tx
             **/
            [key: string]: SubmittableExtrinsicFunction<ApiType>;
