...
export type AddChain = (chainSpec: string, jsonRpcCallback?: JsonRpcCallback) => Promise<Chain>;
export type AddWellKnownChain = (id: WellKnownChain, jsonRpcCallback?: JsonRpcCallback) => Promise<Chain>;
/**
